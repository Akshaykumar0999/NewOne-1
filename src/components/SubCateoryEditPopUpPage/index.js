...
const SubCateoryEditPopUpPage = ({closePopup, defaultValues, updateTheNewRow}) => {
    ...
    return(
        ...
        >
            <form className='popup-details-card'>
                    <h1 className='edit-heading'>Edit Sub-Category</h1>
                    <br />
...
export default SubCateoryEditPopUpPage