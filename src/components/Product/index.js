                ...
                <div className='Home-card-container'>
                    ...
                    <div className='categories-card-container'>
                        <div className='categories-header'>
                            <h1 className='company-sub-heading-is'>Products</h1>
                        ...
                        <div className='categories-details-card'>
                            <div className='categories-input-ul-card'>
                                <p className='company-ul-heading-name'>Products List</p>
                                            ...
                                            <table className='tabel-card'>
                                                <thead className='tabel-headers-card'>
                                                    <tr>
                                                        ...
                                                        <th className='table-headers-css'>PName</th>
                                                        <th className='table-headers-css'>PCode</th>
                                                        <th className='table-headers-css'>Company ID</th>
                                                        <th className='table-headers-css'>Supplier ID</th>
                                                        <th className='table-headers-css'>QtyPerUnit</th>
                                                        <th className='table-headers-css'>Retail Price</th>
                                                        <th className='table-headers-css'>MRP Price</th>
