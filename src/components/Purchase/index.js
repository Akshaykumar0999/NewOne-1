...
const Purchase = () => {
    ...
    // const searchResults = PurchasedList.filter(e => e.name.includes(searchName)) 
                ...
                <div className="Home-app-container">
                    ...
                    <div className='categories-card-container'>
                        <div className='categories-header'>
                            <p className='company-sub-heading-is'>Purchase</p>
                            <p className='category-name-des'><AiFillHome /> Dashboard / Purchase</p>
                        </div>
                        
                        <div className='ul-purchase-conatiner'>
                            <p className='company-ul-heading-name'>Purchase List</p>
                                <div className='company-list-container-card'>
                                    <div className='lists-container'>
                                        <input type='search' className='seach-bar-is' placeholder='Search' />
                                    ...
                                    <>
                                        ...
                                        <Modal size="lg" show={show} onHide={handleClose} >
                                            ...
                                            <Modal.Title>Add New Purchase Information</Modal.Title>
                                            </Modal.Header >
