                ...
                <div className='Home-card-container'>
                    ...
                    <div className='categories-card-container'>
                        <div className='categories-header'>
                            <p className='company-sub-heading-is'>Company</p>
                            <p className='category-name-des'><AiFillHome size={17} className='mb-1' /> Dashboard / Company</p>
                        </div>
                        <div className='categories-details-card'>
                            <div className='categories-input-ul-card'>
                                <p className='company-ul-heading-name'>Companies List</p>
                                    ...
                                    <>
                                        ...
                                        <Modal size="lg" show={show} onHide={handleClose}>
                                            ...
                                            <Modal.Title>Add New Company</Modal.Title>
                                                ...
                                                <form className='form-container add-company' onSubmit={onSubmitCompanyDetails} >
                                                    <div className='input-resposive-container'>
                                                        <div className='input-card-res'>
                                            ...
                                            <div className='tabel-card-container'>
                                                <table className='tabel-card'>
                                                    <thead className='tabel-headers-card'>
                                                        <tr>
                                                            <th className='table-headers-css'>Co Name</th>
                                                            <th className='table-headers-css'>Co Address</th>
                                                            <th className='table-headers-css'>Co(city,State)</th>
                                                            <th className='table-headers-css'>Phone no</th>
                                                            <th className='table-headers-css'>Co Bank</th>
                                                            <th className='table-headers-css'>Co CGSt</th>
