...
import SubCateoryEditPopUpPage from '../SubCateoryEditPopUpPage'
...
const SubCategories = () => {
    ...
    return(
        <div className='app-card-container-classname'>
                ...
                <div className='Home-card-container'>
                    ...
                    <div className='categories-card-container'>
                        <div className='categories-header'>
                            <p className='company-sub-heading-is'>SubCategories</p>
                            <p className='category-name-des'><AiFillHome />Dashboard/SubCategories</p>
                        </div>
                        <div className='categories-details-card'>
                            <div className='categories-input-ul-card'>
                                <p className='company-ul-heading-name'>SubCategories List</p>
                                        ...
                                        <Modal size="lg" show={show} onHide={handleClose}>
                                            ...
                                            <form className='form-container' onSubmit={onSubmitCategory}>
                                                ...
                                                <div className='buttons-container'>
                                                    ...
                                                    <button className='Add-category-button' type='submit'>Add Sub-Category</button>
                                                </div>
                                        </form>
                                        </Modal>
                                    </>
                                                    ...
                                                    {searchResults.map((eachItem, index ) => (
                                                        <tr key={index} className='row-table'>
                                                            <td className='product-img-container'>
                                                                <img src={eachItem.imageUrl} alt={eachItem.id} className='product-img'/>
                                                            </td>
            ...
            <div className='app-container'>
                {openModel && <SubCateoryEditPopUpPage closePopup={() => setOpenModule(false)} defaultValues= {rowToEdit !== null && categoryList[rowToEdit]} updateTheNewRow={updateTheNewRow}/>}
            </div>
        </div>
